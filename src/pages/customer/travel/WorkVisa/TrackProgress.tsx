...
const C = {
  brand: "#8b2b8c", brandHov: "#7c2bb5ff", brandDark: "#1E0A3C",
      ...
      <Box sx={{ display: "flex", flexDirection: "column", alignItems: isMe ? "flex-end" : "flex-start", maxWidth: 220 }}>
        {fileUrl && (
          <Box component="a" href={fileUrl} target="_blank" rel="noopener noreferrer"
            sx={{
              display: "flex", alignItems: "center", gap: 1, mb: message ? 0.5 : 0,
            ...
            <Box sx={{
              width: 30, height: 30, borderRadius: "7px", bgcolor: C.redBg,
...
function useCommentsForApp(
  ...
  return {
    comments, loading, setComments, refresh: fetch, sendError,
  ...
  function getApps(t: ApplicationType) {
    switch (t) {
      case "workVisa": return workVisa.map(item => {
        ...
        return {
          id: String(item.id), country: renderVal(o.country), job: o.job_title || "-",
    ...
    try {
      if (file) {
        ...
        await commentsService.postComment({
          application_id: sel.id, application_type: selType,
        ...
        {TABS.map(t => {
          ...
          return (
            <Box key={t.key} onClick={() => setTab(t.key)} sx={{
              ...
              <Box sx={{
                width: 42, height: 42, borderRadius: "11px", bgcolor: t.iconBg,
              ...
              <Box>
                ...
                <Typography sx={{
                  fontSize: 22, fontWeight: 900, letterSpacing: "-.5px", lineHeight: 1,
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{
              fontSize: 11, fontWeight: 700, color: C.g900,
          ...
          <Box sx={{ px: 1.5, py: 1, borderBottom: `1px solid ${C.g100}`, flexShrink: 0 }}>
            <Box sx={{
              display: "flex", alignItems: "center", gap: 1, bgcolor: C.g100,
          ...
          {/* type pills */}
          <Box sx={{
            display: "flex", px: 1.5, pt: 1, pb: 0, gap: .7, flexShrink: 0,
          ...
          {/* list */}
          <Box sx={{
            flex: 1, overflowY: "auto", px: 1, py: 1, display: "flex",
            ...
            {loading ? (
              ...
              <Box sx={{ py: 5, textAlign: "center" }}>
                <Box sx={{
                  width: 44, height: 44, borderRadius: "12px", bgcolor: C.accentXL,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 20, mx: "auto", mb: 1.5
                }}>{TABS.find(t => t.key === tab)?.emoji}</Box>
              ...
              return (
                <Box key={app.id} onClick={() => { setSelectedId(app.id); setShowAll(false); }}
                  ...
                  <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1.2, mb: .8 }}>
                    ...
                    <Box sx={{
                      fontSize: 9, fontWeight: 700, px: .9, py: .3,
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <Box sx={{ width: 68, height: 4, bgcolor: C.g200, borderRadius: "4px", overflow: "hidden" }}>
                      <Box sx={{
                        height: "100%", borderRadius: "4px", width: `${pg}%`,
        ...
        <Box sx={{
          ...
          {!sel ? (
            <Box sx={{
              ...
              <Box sx={{
                width: 60, height: 60, borderRadius: "16px", bgcolor: C.accentXL,
                display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, mb: 2
              }}>📋</Box>
            ...
            <>
              ...
              <Box sx={{
                ...
                <Box sx={{ position: "relative", zIndex: 1 }}>
                  {/* breadcrumb */}
                  <Box sx={{
                    display: "flex", alignItems: "center", gap: .8, mb: 1.5,
                  ...
                  <Box sx={{
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                      <Box sx={{
                        width: 48, height: 48, borderRadius: "13px", fontSize: 23, flexShrink: 0,
                    ...
                    <Tooltip title={sel.status} placement="bottom-end">
                      <Box sx={{
                        fontSize: 9, fontWeight: 700, px: 1.2, py: .5, borderRadius: "20px",
              ...
              <Box sx={{ px: { xs: 2, sm: 2.5 } }}>
                      ...
                      <Box key={i} sx={{ display: "flex", gap: 1.8 }}>
                        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                          <Box sx={{
                            ...
                            ...(active ? {
                              bgcolor: C.brand, color: "#fff", borderColor: C.brand,
                          ...
                          {!last && (
                            <Box sx={{
                              width: 2, flex: 1, minHeight: 14, my: "3px",
                ...
                {!showAll && sel.steps.length > visSteps.length && (
                  <Box onClick={() => setShowAll(true)} sx={{
                ...
                {showAll && visSteps.length > 5 && (
                  <Box onClick={() => setShowAll(false)} sx={{
                    textAlign: "center", py: 1,
                    ...
                    {[
                      ...
                      <Box key={d.l} sx={{
                        ...
                        <Typography sx={{
                          ...
                          letterSpacing: ".8px", color: C.g400, mb: .5
                        }}>{d.l}</Typography>
                        <Typography sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{ px: 2, py: 1.6, borderBottom: `1px solid ${C.g100}`, flexShrink: 0 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.2, mb: "2px" }}>
              <Box sx={{
                width: 36, height: 36, borderRadius: "10px", bgcolor: C.accentXL,
              ...
              <Box sx={{ display: "flex", gap: .5 }}>
                <IconButton size="small" onClick={() => refreshComments()}
                  sx={{
                    width: 28, height: 28, border: `1.5px solid ${C.g200}`, borderRadius: "7px",
                    "&:hover": { borderColor: C.brand, color: C.brand, bgcolor: C.accentXL }
                  }}>
          ...
          {/* messages */}
          <Box sx={{
            flex: 1, overflowY: "auto", px: 2, py: 1.8,
            ...
            {!sel ? (
              ...
              <Box sx={{
                ...
                <Box sx={{
                  width: 42, height: 42, borderRadius: "12px", bgcolor: C.accentXL,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 19, mb: 1.5
                }}>💬</Box>
                <Typography sx={{ fontSize: 12, fontWeight: 700, color: C.g900, mb: .5 }}>
          ...
          {file && (
            <Box sx={{
              display: "flex", alignItems: "center", gap: 1, mx: 2, mb: .8,
              ...
              <Box onClick={() => setFile(null)} sx={{
                cursor: "pointer",
                color: "#B45309", fontSize: 16, lineHeight: 1, "&:hover": { color: C.red }
              }}>×</Box>
            </Box>
          )}
            ...
            <Box component="form" onSubmit={handleSend} sx={{
              ...
              <Box sx={{ display: "flex", gap: .5, alignItems: "center" }}>
                ...
                <IconButton type="submit" size="small"
                  ...
                  sx={{
                    width: 32, height: 32, borderRadius: "9px", bgcolor: C.brand, color: "#fff",
                    "&:hover": { bgcolor: C.brandHov, boxShadow: "0 4px 16px rgba(182,106,237,.25)" },
        ...
        <Box sx={{ px: 2, py: 1.6, borderBottom: `1px solid ${C.g100}`, flexShrink: 0 }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.2 }}>
            ...
            <IconButton size="small" onClick={() => setChatOpen(false)}
              sx={{
                width: 32, height: 32, borderRadius: "8px", bgcolor: C.g100,
